...
class ConductedExam(models.Model):
    course = models.ForeignKey(Course, on_delete=models.CASCADE)
    batch = models.ForeignKey(Batch, on_delete=models.CASCADE)
    created_by = models.ForeignKey(Trainer, on_delete=models.SET_NULL, null=True, blank=True)
    ...
    def __str__(self):
        return f"{self.exam_name} ({self.course.name} - {self.batch.name})"
...
class ExamResult(models.Model):
    ...
    exam_name = models.ForeignKey(ConductedExam,on_delete=models.CASCADE, related_name='results')
